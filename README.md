...
- `/assets/site.js`: client-side email brief preparation; no server submission.
...
Contact links use the existing public portfolio address, `harrilal20@gmail.com`, and published US phone number. The form validates input, prepares a `mailto:` link and explicitly asks the visitor to send it in their email app. No success/submission claim, backend, storage or tracking is added. Direct email and telephone links are available as alternatives.
